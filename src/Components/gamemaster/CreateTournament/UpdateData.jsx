...
const CreateTournamentGamemasterComp = () => {
    ...
    return (
        ...
        <div className='w-[90%] p-[5%] flex flex-col items-start text-black max-[600px]:items-center max-[600px]:justify-center'>
            ...
            <div className='w-full grid sm:grid-cols-[150px_minmax(50%,_1fr)_10%] place-content-center max-[600px]:flex-col '>
...
export default CreateTournamentGamemasterComp;
